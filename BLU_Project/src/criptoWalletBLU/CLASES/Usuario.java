...
public class Usuario {
	...
	/**
	 * @param pregunta  ;Las preguntas y respuestas las ingresa el usuario desde la
	 *                  Vista
	 * @param respuesta ;Las preguntas y respuestas las ingresa el usuario desde la
	 *                  Vista
	 */
	...
	/**
	 * @param moneda      ;El usuario ingresa los datos de la opercion desde la
	 *                    Vista y la clase DefiTransaccion se encarga de crear los
	 *                    parametros
	 * @param fechaInicio ;El usuario ingresa los datos de la opercion desde la
	 *                    Vista y la clase DefiTransaccion se encarga de crear los
	 *                    parametros
	 * @param protocolo   ;El usuario ingresa los datos de la opercion desde la
	 *                    Vista y la clase DefiTransaccion se encarga de crear los
	 *                    parametros
	 */
